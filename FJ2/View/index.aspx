...
<title>FJ2 Virtual Store Games</title>
<meta name="description" content="Consigue los mejores VideoJuegos y al mejor precio."/>
...
<div class="site-wrapper">
	...
	<a class="blog-logo" href="index.aspx"><img src="assets/img/logo2.png" /></a>
	<ul id="menu">
	...
	<header class="main-header " style="background-image: url(assets/img/fondo.jpg)">
	<div class="vertical">
		<div class="main-header-content inner">
			<h1 class="page-title">Assassin´s Creed Valhalla</h1>
			<div class="entry-title-divider">
				<span></span><span></span><span></span>
			</div>
			<h2 class="page-description">Consigue los mejores VideoJuegos y al mejor precio.</h2>
		</div>
	</div>
